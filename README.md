...
- 与桌面牌**颜色相同** / **数字相同** / **类型相同** 即可打出
- 万能牌（Wild/Wild+4）可打在**任意牌**上
- 被 +2 或 +4 惩罚时**必须抓牌**，不能出牌逃避
- 每回合最多**自愿抓 1 张**；抓完不能出则自动跳到下家
...
| 数字牌 | `RED 5` | 无 |
| 跳过 | `RED SKP` | 下家跳过 |
| 反转 | `RED REV` | 方向翻转（2 人局=跳过） |
| +2 | `RED +2` | 下家抓 2 张并跳过 |
| 万能 | `WILD` | 选颜色，无其他效果 |
| 万能 +4 | `WILD +4` | 选颜色，下家抓 4 张并跳过 |

### UNO

- 手牌剩 **1 张** 时必须点击 **Call UNO!**
- 出牌后没喊 UNO，下一位玩家动作时会被发现并**罚抓 2 张**
- 在被发现前补喊 UNO 可以补救
...
> 完整规则细节见 [docs/游戏规则.md](docs/游戏规则.md)
